...
comments: true
layout: post
title: SASS Javascript Login 
description: Team teach about SASS Javascript login 
  ...
  <form action="javascript:login_user()">
    ...
    <p>
     <button class="button-spacing">Log In</button>
          <button onClick = "window.location.href ='http://localhost:4200/student2//2023/01/22/Signup_page_demographics.html'" class="button-spacing" >Sign Up</button>
